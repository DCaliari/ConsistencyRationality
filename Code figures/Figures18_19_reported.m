...
bin(:,1) = ( XYZW_rep==1 & deliberate_time==0 ) ;
bin(:,2) = (  WZYX_rep==1 & deliberate_time==0  ) ;
...
bin(:,3) = deliberate;
bin(:,1) = ( ABCD_rep==1 & deliberate ==0 ) ;
bin(:,2) = (  DCBA_rep==1  & deliberate ==0 ) ;
bin(:,4) = bin(:,1)+bin(:,2)+bin(:,3)==0;
...
y_bracket_34 = 15.2;  % Bin 3 vs Bin 4
% y_bracket_13 = 16.5;  % Bin 1 vs Bin 3
y_bracket_14 = 12.2;  % Bin 1 vs Bin 4
y_bracket_24 = 13.7; % Bin 2 vs Bin 4
...
% y_bracket_13 = 16.5;  % Bin 1 vs Bin 3
y_bracket_14 = 13.2;  % Bin 1 vs Bin 4
